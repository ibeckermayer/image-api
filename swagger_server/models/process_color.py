...
class ProcessColor(Model):
    ...
    def __init__(self, type: str=None, list_of_parameter: List[Parameter]=None):  # noqa: E501
        ...
        :type type: str
        :param list_of_parameter: The list_of_parameter of this ProcessColor.  # noqa: E501
    ...
    def list_of_parameter(self) -> List[Parameter]:
        """Gets the list_of_parameter of this ProcessColor.

        Parameter list to further specify the process, if necessary.  # noqa: E501

        :return: The list_of_parameter of this ProcessColor.
    ...
    def list_of_parameter(self, list_of_parameter: List[Parameter]):
        """Sets the list_of_parameter of this ProcessColor.

        Parameter list to further specify the process, if necessary.  # noqa: E501

        :param list_of_parameter: The list_of_parameter of this ProcessColor.
        :type list_of_parameter: List[Parameter]
        """
