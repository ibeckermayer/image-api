...
class ProcessMedianFilter(Model):
    ...
    def name(self, name: str):
        """Sets the name of this ProcessMedianFilter.

        The name of image processing you want to preform. See Enum for array of supported processes.  # noqa: E501

        :param name: The name of this ProcessMedianFilter.
        :type name: str
        """
