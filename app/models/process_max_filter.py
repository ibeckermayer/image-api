...
class ProcessMaxFilter(Model):
    ...
    def name(self, name: str):
        """Sets the name of this ProcessMaxFilter.

        The name of image processing you want to preform. See Enum for array of supported processes.  # noqa: E501

        :param name: The name of this ProcessMaxFilter.
        :type name: str
        """
    ...
    def array_of_parameter(self) -> List[Parameter]:
        """Gets the array_of_parameter of this ProcessMaxFilter.

        Parameter array to further specify the process, if necessary.  # noqa: E501

        :return: The array_of_parameter of this ProcessMaxFilter.
    ...
    def array_of_parameter(self, array_of_parameter: List[Parameter]):
        """Sets the array_of_parameter of this ProcessMaxFilter.

        Parameter array to further specify the process, if necessary.  # noqa: E501

        :param array_of_parameter: The array_of_parameter of this ProcessMaxFilter.
        :type array_of_parameter: List[Parameter]
        """
